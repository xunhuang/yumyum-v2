        ...
        navList: [
            {
                ...
                navList:
                    [
                        ...
                        { url: '/list/CoventGarden?lat=51.5110973&lng=-0.12677', label: 'Covent Garden' },
                        { url: '/list/Mayfair?lat=51.510435&lng=-0.148056', label: 'Mayfair' },
                        { url: '/list/Chelsea?lat=51.488010&lng=-0.169268', label: 'Chelsea' },
                        { url: '/list/CityOfLondon?lat=51.513782&lng=-0.089875', label: 'City of London' },
                    ],
            },
        ],
    },
        ...
        navList: [
            {
                ...
                navList:
                    [
                        { url: '/list/RiverNorth?lat=41.891892&lng=-87.633322', label: 'River North' },
                        { url: '/list/WestLoop?lat=41.884388&lng=-87.653893', label: 'West Loop' },
                        { url: '/list/LoganSquare?lat=41.921060&lng=-87.701703', label: 'Logan Square' },
                        { url: '/list/LincolnPark?lat=41.921504&lng=-87.647000', label: 'Lincoln Park ' },
                    ],
            }],
    },
    {
        ...
        navList: [
            {
                ...
                navList:
                    [
                        { url: '/list/DowntownLA?lat=34.045763&lng=-118.250638', label: 'Downtown LA' },
                        { url: '/list/Hollywood?lat=34.086172&lng=-118.331637', label: 'Hollywood' },
                        { url: '/list/SantaMonica?lat=34.011648&lng=-118.493042', label: 'Santa Monica' },
                        { url: '/list/Pasadena?lat=34.151776&lng=-118.144878', label: 'Pasadena' },
                        { url: '/list/SantaAna?lat=33.781369&lng=-117.880802', label: 'Santa Ana' },
                    ],
            }],
    },
    {
